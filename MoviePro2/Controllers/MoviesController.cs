...
namespace MoviePro2.Controllers
{
    public class MoviesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MovieID,Title,TagLine,Overview,ReleaseDate,Poster,ContentType,BGImage,BGContentType,Trailer,Rating")] Movie movie, IFormFile NewPoster, IFormFile NewBGImage)
        {
            if (id != movie.Id)
            {
                return NotFound();
